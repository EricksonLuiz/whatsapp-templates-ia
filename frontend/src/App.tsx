...
const AppRoutes = () => (
  <Layout>
    <Routes>
      ...
      />
      <Route
        path="/cliente/:clientId/categorias"
        element={
          <ProtectedRoute>
            <ClientCategories />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/cliente/:clientId/categoria/:categoryId/templates"
        element={
          <ProtectedRoute>
            <CategoryTemplates />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/cliente/:clientId/categoria/:categoryId/template/novo"
        element={
          <ProtectedRoute>
            <TemplateForm />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/cliente/:clientId/categoria/:categoryId/template/ia"
        element={
          <ProtectedRoute>
            <TemplateAI />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/categoria/:categoryId/editar"
        element={
          <ProtectedRoute>
            <CategoryEdit />
          </ProtectedRoute>
