...
const CategoryTemplates = () => {
  ...
  const templates = getCategoryTemplates(categoryId!, clientId!);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">{client.name} - {category.name}</h1>
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        <button
          onClick={() => navigate(`/cliente/${clientId}/categoria/${categoryId}/template/novo`)}
        ...
        <button
          onClick={() => navigate(`/cliente/${clientId}/categoria/${categoryId}/template/ia`)}
      ...
      {templates.length === 0 && (
        <Card className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold text-white mb-2">Nenhum template criado</h3>
          ...
          <Card className="w-full max-w-2xl max-h-[80vh] overflow-y-auto">
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-1">Rodapé</label>
                  <p className="p-3 bg-white/5 border border-white/10 rounded-lg text-white">
                ...
                {selectedTemplate.variables.length > 0 && (
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-1">Variáveis</label>
                ...
                {selectedTemplate.buttons.length > 0 && (
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-1">Botões</label>
                    <div className="flex flex-wrap gap-2">
                      {selectedTemplate.buttons.map((button: string, index: number) => (
              ...
              <div className="flex space-x-4 pt-4">
                ...
                <button
                  onClick={() => navigate(`/cliente/${clientId}/categoria/${categoryId}/template/${selectedTemplate.id}/editar`)}
